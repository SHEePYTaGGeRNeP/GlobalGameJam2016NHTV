namespace Assets.Scripts
{
    ...
    public class RailingCamera : MonoBehaviour
    {

        public bool MoveOverX, MoveOverY, MoveOverZ;
        ...
        private void Update()
        {
            if (!this._moveCamera)
            {
                ...
                this.CheckIfCameraShouldMove();
                this._moveCamera = !this._moveCamera;
                return;
            }
            this._moveCamera = !this._moveCamera;
            if (this._endMarker == Vector3.zero) return;

            this.transform.LookAt(this._targetPosition);
            /*
            Vector3 lookPos = this._targetPosition - this.transform.position;
            lookPos.y = 0;
